...
document.addEventListener("click", function(e) {
  ...
  allowDark && t == chkb && (chkb.checked ? (them.href = "css/dark.css", window.localStorage.setItem("darktheme", "css/dark.css")) : (them.href = "css/light.css", window.localStorage.setItem("darktheme", "css/light.css")));
}, false);
...
window.addEventListener("DOMContentLoaded", function() {
  ...
  if (!window.matchMedia("(prefers-color-scheme: dark)").matches) {
    ...
    allowDark = true;
    if (null !== dark) {
      if ("css/dark.css" == dark) {
	    chkb.checked = true;
	    them.href = "css/dark.css";
      } else {
        chkb.checked = false;
	    them.href = "css/light.css";
      }
    }
  }
},false);